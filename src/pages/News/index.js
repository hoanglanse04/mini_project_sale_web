      ...
      <div className="news">
        ...
        <div className="news__item">
          ...
          <div className="item__desc" >
            ...
            <a><Link to='/Aticle_01'>VIEW DETAIL</Link></a>
          </div>
        </div>
        <div className="news__item">
          ...
          <div className="item__desc" >
            ...
            <a><Link to='/Aticle_02'>VIEW DETAIL</Link></a>
          </div>
        </div>
        ...
        <div className="news__item">
          ...
          <div className="item__desc" >
            ...
            <a><Link to='/Aticle_03'>VIEW DETAIL</Link></a>
          </div>
        </div>
        <div className="news__item">
          ...
          <div className="item__desc" >
            ...
            <a><Link to='/Aticle_04'>VIEW DETAIL</Link></a>
          </div>
        </div>
        <div className="news__item">
          ...
          <div className="item__desc" >
            ...
            <a><Link to='/Aticle_05'>VIEW DETAIL</Link></a>
          </div>
        </div>
        </div>
